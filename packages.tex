...
\title[FE approximation of the 1-d fractional Poisson equation]{Finite Element approximation of the one-dimensional fractional Poisson equation with applications to numerical control}
